/*
  ...
  - You are about to drop the column `replayId` on the `participants_on_messages` table. All the data in the column will be lost.
...
INSERT INTO "new_participants_on_messages" ("createdAt", "id", "isRead", "messageId", "recipientDeleted", "recipientId", "senderDeleted", "senderId", "updatedAt") SELECT "createdAt", "id", "isRead", "messageId", "recipientDeleted", "recipientId", "senderDeleted", "senderId", "updatedAt" FROM "participants_on_messages";
